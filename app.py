...
def login():
    if(is_logged_in()):
        ...
        contr_title_list = [db.get_title(story_id) for story_id in list_contr_story_id] # List of all contributed-to story titles
        uncontr_title_list = [db.get_title(story_id) for story_id in allStories if story_id not in list_contr_story_id] # List of all uncontributed-to story titles
